        ...
        <div className="matching-inner">
          ...
          <div className="algo-card">
            <div className="algo-row">
              <div className="algo-icon blue-bg"><Search size={24} color="#1a56db" /></div>
            ...
            <div className="algo-row">
              <div className="algo-icon green-bg"><CheckCircle size={24} color="#0ea86a" /></div>
              <div className="algo-text">
                <h4>60% threshold</h4>
            ...
            <div className="algo-row">
              <div className="algo-icon amber-bg"><TrendingUp size={24} color="#b45309" /></div>
              <div className="algo-text">
                <h4>Ranked by fit</h4>
            ...
            <div className="score-demo">
              ...
              <div className="score-row">
                <div className="score-name">Senior Frontend Eng.</div>
                <div className="score-bar-wrap"><div className="score-bar" style={{ width: '92%' }}></div></div>
                <div className="score-pct">92%</div>
                <div className="score-match">Matched</div>
              </div>
              <div className="score-row">
